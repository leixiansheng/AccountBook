package com.leixiansheng.accountbook.view;
...
import com.leixiansheng.accountbook.R;

import java.util.Calendar;

/**
 * Created by Leixiansheng on 2017/9/28.
 */

public class MonDatePickerDialog extends AlertDialog implements DatePicker.OnDateChangedListener {
    ...
    public MonDatePickerDialog(Context context, OnDateSetListener callBack,
                               int year, int monthOfYear, int dayOfMonth) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth);
    }

    public MonDatePickerDialog(Context context, int theme,
